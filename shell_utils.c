...
/**
 * Auth: Sherif Muhammed Modupe Abereola
 *
 ...
 *
 * Return: constant representing the typpe of the command
 * Description -
...
void execute_command(char **tokenized_command, int command_type)
{
	...
	{
		if (execve(check_path(tokenized_command[0]), tokenized_command, NULL)
		{
			perror(_getenv("PWD"));
			exit(2);
		}
